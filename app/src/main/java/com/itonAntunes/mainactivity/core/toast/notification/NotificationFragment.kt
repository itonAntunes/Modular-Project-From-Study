package com.itonAntunes.mainactivity.core.toast.notification
...
class NotificationFragment : Fragment(R.layout.fragment_notification) {
    ...
    private fun updateNotification() {
        ...
        val androidImage = BitmapFactory.decodeResource(resources, R.drawable.ic_notification) //* não reconhece a mensagem com a imagem *
